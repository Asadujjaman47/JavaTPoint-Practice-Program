package doubly_linked_list.p7.remove_duplicate_element;
...
public class RemoveDuplicate {
    ...
    public void removeDuplicateNode() {
        // Node current will point ti head
            ...
            for (current = head; current != null; current = current.next) {
                ...
                for (index = current.next; index != null; index = index.next) {
                    if (current.data == index.data) {
                        ...
                        temp = index;
                        // index's previous node will point to node next to index thus, remove the duplicate node
