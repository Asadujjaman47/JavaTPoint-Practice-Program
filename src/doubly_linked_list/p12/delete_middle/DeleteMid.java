package doubly_linked_list.p12.delete_middle;
...
public class DeleteMid {
    ...
    DeleteMid.Node head, tail = null;

    // addNode() will add a node to the list
    public void addNode(int data) {
        // Create a new node
        DeleteMid.Node newNode = new DeleteMid.Node(data);
    ...
    public void deleteFromMid() {
        ...
        // currently will point to head
        DeleteMid.Node current = head;
