package doubly_linked_list.p10.binary_tree_to_dll;
...
public class BinaryTreeToDLL {
    ...
    // Represent the head and tail of the double linked list
    Node head, tail = null;

    // convertbtToDDL() will convert the given binary tree to corresponding doubly linked list
