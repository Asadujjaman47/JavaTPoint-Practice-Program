package singly_linked_list.p5.insert_node_beginning;
...
public class InsertStart {
    ...
    // addAtStart() will add a new node to the end of the list
    public void addAtStart(int data) {
        ...
        if(head == null) {
            ...
            // Node tem[ will point to head
            Node temp = head;
            // newNode will be become new head of the list
            head = newNode;
