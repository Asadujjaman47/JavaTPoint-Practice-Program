package circular_linked_list.p10.delete_middle;
...
public class DeleteMid {
    ...
    // Deletes nodes from the middle of the list
    public void deleteMid() {
        ...
        if (head != tail) {
            ...
            if (current != null) {
                ...
                // So, current node will point to node next to temp by skipping temo
